...
export default function Contact() {
  return (
    <main>
      ...
      <p>This privacy policy ("policy") will help you understand how [company name] ("us", "we",
      ...
      changes, we advise you to frequently visit this page.</p>
      ...
      <p>[company name] is committed to securing your data and keeping it confidential.
      [company name] has done all in its power to prevent data theft, unauthorized access,
      ...
      that we can provide a better experience for you.</p>
      ...
      [company name] is not held responsible for your data and privacy protection. Visiting
      those websites is not governed by this privacy policy agreement. Make sure to read the
      privacy policy documentation of the website you go to from our website.</p>
      ...
      <p>[company name] will not lease, sell or distribute your personal information to any third
